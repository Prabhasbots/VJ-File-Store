...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 𝐉ⱺ𝗂𐓣 𝐓𝖾ᥣ𝖾𝗀𝗋αꭑ 𝐂ɦα𐓣𐓣𝖾ᥣ', url='https://t.me/SVMRIPPS')
            ],[
            InlineKeyboardButton('🔍 𝐒𝐕𝐌𝐑𝗂ρρ𝗌', url='https://t.me/SVMRIPPS'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/SVMRIPPS')
            ],[
